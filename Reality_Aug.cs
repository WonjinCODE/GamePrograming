...
public class Reality_Aug : MonoBehaviour
{
    Rigidbody rigid;
    ...
    void Update()
    {
        ...
        //{
        //  Vector3 vec1 = new Vector3(0, JumpPower, 0);
        //rigid.AddForce(vec, ForceMode.Impulse);
        //}

        if (Input.GetButtonDown("Successive_Jump"))
        {
            Vector3 vec = new Vector3(0, JumpPower, 0);
            Debug.Log("슈퍼 점프!" + Input.GetAxisRaw("Successive_Jump"));
            rigid.AddForce(vec, ForceMode.Impulse);
        }
